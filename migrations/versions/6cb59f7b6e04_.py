...
Revision ID: 6cb59f7b6e04
Revises: a12eea3c9b03
Create Date: 2022-08-12 20:27:44.490381
...
revision = '6cb59f7b6e04'
down_revision = 'a12eea3c9b03'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('Artist', sa.Column('seeking_venue', sa.String(length=120), nullable=False))
    op.add_column('Artist', sa.Column('seeking_description', sa.String(length=120), nullable=True))
    op.add_column('Artist', sa.Column('websitelink', sa.String(), nullable=True))
    ...
    op.add_column('Venue', sa.Column('seeking_venue', sa.String(length=120), nullable=False))
    op.add_column('Venue', sa.Column('seeking_description', sa.String(length=120), nullable=True))
    op.add_column('Venue', sa.Column('websitelink', sa.String(), nullable=True))
